...
fun RecyclerView.withSharedViewPool(pool: RecyclerView.RecycledViewPool? = null) = apply {
    setRecycledViewPool(pool ?: sharedViewPool)
}

fun RecyclerView.setupWithPrefetchingLinearLayoutAndSharedViewPool(
    recyclerAdapter: RecyclerAdapter,
    initialPrefetch: Int = 5,
    pool: RecyclerView.RecycledViewPool? = null
) {
